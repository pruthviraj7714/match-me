              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl">
                    Join Matchme and discover meaningful connections. Our
                    advanced algorithm ensures you meet people who truly
                    resonate with you.
                  </p>
                </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-gray-500">
                  Our AI-powered algorithm ensures you meet compatible partners.
                </p>
              </div>
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="bg-pink-100 p-3 rounded-full">
                ...
                <p className="text-gray-500">
                  Enjoy secure and private conversations with your matches.
                </p>
              </div>
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="bg-pink-100 p-3 rounded-full">
                ...
                <p className="text-gray-500">
                  Rest easy knowing all our users are real and verified.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center text-center space-y-4 p-6 bg-white rounded-lg shadow-lg">
                <Image
                  ...
                  height={100}
                  src="https://i.pinimg.com/736x/4b/a5/4b/4ba54b157e0cf71a47fe7fccbe764e81.jpg"
                  width={100}
                />
                <h3 className="text-xl font-bold">Sarah & John</h3>
                <p className="text-gray-500">
                  "Thanks to Matchme, we found each other and have been happily
              ...
              <div className="flex flex-col items-center text-center space-y-4 p-6 bg-white rounded-lg shadow-lg">
                <Image
                  ...
                  className="rounded-full"
                  height={100}
                  src="https://i.pinimg.com/736x/76/86/8d/76868d470ea6cd8319f7958b92bde6d7.jpg"
                  width={100}
                />
                <h3 className="text-xl font-bold">Emily & Michael</h3>
                <p className="text-gray-500">
                  "We never thought we'd find love online, but Matchme made it
              ...
              <div className="flex flex-col items-center text-center space-y-4 p-6 bg-white rounded-lg shadow-lg">
                <Image
                  ...
                  className="rounded-full"
                  height={100}
                  src="https://i.pinimg.com/736x/b7/dd/ea/b7ddeaa4f1de6d4b2d93bde1193b26ee.jpg"
                  width={100}
                />
                <h3 className="text-xl font-bold">David & Lisa</h3>
                <p className="text-gray-500">
                  "Matchme's algorithm is spot-on! We're so compatible and have
          ...
          <div className="px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="max-w-[600px] text-white md:text-xl">
                Join thousands of happy couples who found love on Matchme. Your
